      ...
      <div className="container relative">
        <div className="flex flex-col items-center text-center relative z-10">
          <Title size={"7.5xl"} className={"font-normal max-w-[776px]"}>
            <span className="relative">Sunny Valley <span className="absolute -left-6 top-1 text-3xl text-[#0A6375]"><ThreeLine /></span></span>
            <span className="font-bold">Early Learning</span> <span className="font-bold text-destructive-foreground">Center</span>
          </Title>
          ...
          <p className="pt-5 max-w-[431px]">A warm and nurturing space where little learners grow, explore, and thrive.</p>
          <div className="mt-6">
