                ...
                <div className="container">
                    <div className="grid lg:grid-cols-[37%_auto] grid-cols-1 items-center xl:gap-20 gap-10">
                        ...
                        <div>
                            ...
                            <SectionDescription className={'pt-5 pb-7.5'}>we recognize that every child grows at their own pace. That’s why we offer age-appropriate programs designed to nurture creativity, confidence, and social skills through play-based learning.</SectionDescription>
